# Pokémon Interactive Explorer Web Application
...
* https://pokeapi.co/
  Used for Pokémon data such as name, stats, types, abilities, and images.

* https://pokeapi.co/api/v2/pokemon-species/
  Used for Pokémon descriptions and species information.

* https://pokemontcg.io/
  Used for high-quality Pokémon card images (optional enhancement).

* https://raw.githubusercontent.com/PokeAPI/sprites/
  Used for animated Pokémon sprites.
...
* Show detailed description for each Pokémon
